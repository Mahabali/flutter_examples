...
import 'package:flutter_example/screen_2.dart';
...
class StateManagementApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Screen1Page(title: 'Flutter Demo Home Page'),
      routes: <String, WidgetBuilder> {
        '/screen1': (BuildContext context) => const Screen1Page(title: 'Screen 1'),
        '/screen2': (BuildContext context) => const Screen2Page(title: 'Screen 2'),
      },
    );
  }
}
...
class Screen1Page extends StatefulWidget {
  const Screen1Page({super.key, required this.title});
...
class _Screen1PageState extends State<Screen1Page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        // Here we take the value from the Screen1Page object that was created by
